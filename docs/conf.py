...
tutorials_source = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "PyDynamic_tutorials")
)
...
htmlhelp_basename = "PyDynamic_tutorials_doc"
...
man_pages = [
    (
        master_doc,
        "PyDynamic_tutorials",
        "PyDynamic_tutorials " "Documentation",
        [author],
        1,
    )
]
